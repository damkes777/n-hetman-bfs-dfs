...
def prepare_data(n, intelligent_flag):
    ...
    hetman_problem = HetmanProblemDFS(n, intelligent_flag)
    time_end = time.time()

    final_time = round((time_end - time_start) * 1000, 2)
    solutions = hetman_problem.get_solutions()
...
file.save_as_txt(times_intelligent, 'files/times_intelligent.txt')
file.save_as_txt(visited_intelligent, 'files/visited_intelligent.txt')
file.save_as_txt(generated_intelligent, 'files/generated_intelligent.txt')
file.save_as_csv(solutions_intelligent, 'files/solutions_intelligent.csv')

plot.draw_plot(visited_intelligent, 'Visited intelligent', 'n-hetman', 'visited', 4, 11, 'plots/visited_intelligent.png')
plot.draw_plot(generated_intelligent, 'Generated intelligent', 'n-hetman', 'generated', 4, 11, 'plots/generated_intelligent.png')
plot.draw_plot(times_intelligent, 'Times intelligent', 'n-hetman', 'times', 4, 11, 'plots/times_intelligent.png')
